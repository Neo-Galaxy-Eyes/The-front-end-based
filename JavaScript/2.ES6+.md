...
与Object.keys()方法类似，但返回的是一个对象里面所有值组成的数组：
...
解决对象的getter和setter属性不能通过Object.assign()来完全复制的问题：
...
console.log(p1.fullName) // Neo Eyes

const p2 = Object.assign({}, p1)
p2.firstName = 'nexus'
//原因是Object.assign()把fullName当作一个普通的属性来进行复制
console.log(p2.fullName) // Neo Eyes

//获取对象中属性的完整描述信息，包含value/writable/enumerable/configurable
const descriptors = Object.getOwnPropertyDescriptors(p1)
const p2 = Object.defineProperties({}, descriptors)
p2.firstName = 'nexus'
console.log(p2.fullName) // nexus Eyes
```
